...
```bash
git add frontend/src/components/workspace/submarine-runtime-panel.utils.ts frontend/src/components/workspace/submarine-runtime-panel.utils.test.ts frontend/src/components/workspace/submarine-runtime-panel.tsx docs/archive/superpowers/specs/2026-03-27-vibe-cfd-requested-outputs-status.md
