...
| `src/components/workspace/submarine-pipeline.tsx` | Create | Main container: ResizablePanelGroup (submarine sidebar + center + chat rail)锛屽惈 chatOpen 鍝嶅簲寮忛€昏緫鍜?onLayoutChanged 鎸佷箙鍖?|
...
```powershell
cd C:\Users\D0n9\Desktop\棰犺鎬уぇ璧沑frontend
...
1. Brand header: VibeCFD 路 DeerFlow
      ...
      <div className="px-2.5 pb-1 pt-2">
        ...
        {runs.map((run) => (
          ...
          >
            ...
            >
              {run.isRunning ? "鈼?杩愯涓? : run.isComplete ? "鉁?宸插畬鎴? : "鈼?寰呰繍琛?}
            </div>
          </div>
        ))}
      </div>
...
// 鈹€鈹€ Shared runtime snapshot type (re-declared locally to avoid coupling) 鈹€鈹€鈹€鈹€鈹€鈹€
...
// 鈹€鈹€ TaskIntelligenceCard 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
export function TaskIntelligenceCard({
  ...
  const handleConfirm = useCallback(() => {
    setConfirming(true);
    onConfirm(threadId, { role: "human", content: "纭鏂规锛屽紑濮嬫墽琛? });
  }, [threadId, onConfirm]);

  const handleModify = useCallback(() => {
    onConfirm(threadId, {
      role: "human",
      content: "鎴戦渶瑕佽皟鏁磋绠楁柟妗堬紝璇风◢绛?,
    });
  }, [threadId, onConfirm]);
  ...
  const descriptionText =
    state === "done"
      ? brief?.task_description?.slice(0, 60) ?? "宸茬‘璁ゆ柟妗?
      : state === "active"
  ...
  return (
    ...
    >
      ...
      {caseId && (
        <div className="mb-3">
          <SectionLabel color="sky">妫€绱㈠埌鐩镐技妗堜緥</SectionLabel>
              ...
              <div>
                ...
                {simReq?.inlet_velocity_mps != null && (
                  <div className="mt-0.5 text-[10px] text-stone-500">
                    鍏ュ彛閫熷害 {simReq.inlet_velocity_mps} m/s
                  </div>
                )}
              </div>
            </div>
      ...
      {simReq && (
        <div className="mb-3">
          <SectionLabel color="amber">寤鸿璁＄畻鏂规</SectionLabel>
          <div className="rounded-md border border-amber-200 bg-amber-50 px-3 py-2.5">
            <div className="flex flex-wrap gap-x-4 gap-y-2">
              {simReq.inlet_velocity_mps != null && (
                <PlanItem label="鍏ュ彛閫熷害" value={`${simReq.inlet_velocity_mps} m/s`} />
              )}
              {simReq.fluid_density_kg_m3 != null && (
                <PlanItem label="娴佷綋瀵嗗害" value={`${simReq.fluid_density_kg_m3} kg/m鲁`} />
              )}
              {simReq.kinematic_viscosity_m2ps != null && (
                <PlanItem
                  label="杩愬姩榛忓害"
                  value={`${simReq.kinematic_viscosity_m2ps.toExponential(2)} m虏/s`}
                />
              )}
              {simReq.end_time_seconds != null && (
                <PlanItem label="妯℃嫙鏃堕暱" value={`${simReq.end_time_seconds} s`} />
              )}
            </div>
          </div>
        </div>
      ...
      {openQuestions.length > 0 && (
        <div className="mb-3">
          <SectionLabel color="red">寰呯‘璁ら棶棰?/SectionLabel>
          <ul className="space-y-1">
            {openQuestions.map((q, i) => (
              <li key={i} className="flex gap-1.5 text-[11px] text-stone-600">
                <span className="shrink-0 text-amber-500">鈿?/span>
                {q}
              </li>
            ))}
          </ul>
      ...
      {/* Confirm actions 鈥?only when active and waiting for user */}
      {state === "active" && (
        <div className="mt-2 flex gap-2">
          ...
          >
            {confirming ? "鍙戦€佷腑鈥? : "鉁?纭鏂规锛屽紑濮嬫墽琛?}
          </button>
          <button
            type="button"
...
// 鈹€鈹€ GeometryPreflightCard 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
export function GeometryPreflightCard({
  ...
  const description =
    state === "done"
      ? geometry?.summary_zh?.slice(0, 60) ?? "鍑犱綍棰勬閫氳繃"
      : state === "active"
        ? "姝ｅ湪妫€鏌ュ嚑浣曗€?
        : "绛夊緟浠诲姟鐞嗚В瀹屾垚";
  ...
  return (
    ...
    >
      ...
      {!geometry && state === "active" && (
        <div className="text-[11px] text-stone-400">鍑犱綍妫€鏌ヨ繍琛屼腑鈥?/div>
      )}
    </StageCard>
  );
}

// 鈹€鈹€ SolverDispatchCard 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
export function SolverDispatchCard({
  ...
  return (
    <StageCard
      ...
      rightLabel={
        state === "active" ? (
          <span className="text-[11px] font-medium text-blue-500">杩愯涓?/span>
        ) : undefined
      }
      defaultExpanded={state === "active"}
    >
      ...
      {lastEvent && (
        <div className="rounded bg-stone-100 px-2 py-1 font-mono text-[10px] text-stone-500">
          <span className="text-green-500">鈻?/span>{" "}
          {lastEvent.actor ? `[${lastEvent.actor}] ` : ""}
          {lastEvent.title ?? lastEvent.summary ?? "鈥?}
        </div>
      )}
    </StageCard>
  );
...
// 鈹€鈹€ ResultReportingCard 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
export function ResultReportingCard({
  ...
  const description =
    state === "done"
      ? cd != null ? `Cd = ${cd.toFixed(5)}` : "鎶ュ憡宸茬敓鎴?
      : state === "active"
        ? "缁撴灉鏁寸悊涓€?
        : "绛夊緟姹傝В瀹屾垚";
  ...
  return (
    ...
    >
      ...
      {state === "active" && !cd && (
        <div className="text-[11px] text-stone-400">姝ｅ湪鏁寸悊璁＄畻缁撴灉鈥?/div>
      )}
    </StageCard>
  );
}

// 鈹€鈹€ SupervisorReviewCard 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€

const REVIEW_STATUS_LABELS: Record<string, string> = {
  ready_for_supervisor: "寰呭鏍?,
  needs_user_confirmation: "寰呯敤鎴风‘璁?,
  blocked: "宸查樆濉?,
};
  ...
  return (
    ...
    >
      ...
      {state === "active" && !reviewStatus && (
        <div className="text-[11px] text-stone-400">Supervisor 姝ｅ湪澶嶆牳鈥?/div>
      )}
    </StageCard>
  );
}

// 鈹€鈹€ Shared helpers 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
## Task 6: (Removed 鈥?Activity Bar deferred to Plan B)
...
// 鈹€鈹€ Persistence helpers 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
// 鈹€鈹€ Runtime snapshot type (mirrors SubmarineRuntimePanel) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
// 鈹€鈹€ Props 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
export function SubmarinePipeline({
  ...
  // 鈹€鈹€ Responsive chat toggle 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
  // Default false: < xl starts with chat hidden; xl always shows chat via CSS
  const [chatOpen, setChatOpen] = useState(false);

  // 鈹€鈹€ Run list from useThreads (filter submarine threads) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
  ...
  // 鈹€鈹€ Layout persistence 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
  ...
  // 鈹€鈹€ Runtime state 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
  ...
  // 鈹€鈹€ Snapshot for stage cards 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
  ...
  // 鈹€鈹€ Callbacks 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
  ...
  // < xl : single column 鈥?center only; chat toggle owned by page.tsx header button
  return (
    <div className="flex h-full min-h-0 flex-col overflow-hidden">
      {/* 3-pane resizable layout 鈥?full height on xl, flex column on mobile */}
...
// 鈹€鈹€ PipelineCenterPane (extracted to avoid JSX duplication between mobile/xl) 鈹€
...
function PipelineCenterPane({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      {/* Center header 鈥?xl only (mobile header is in parent) */}
...
// 鈹€鈹€ PipelineChatRail 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
// 鈹€鈹€ Small presentational helpers 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
```powershell
Get-Content "C:\Users\D0n9\Desktop\棰犺鎬уぇ璧沑frontend\src\components\workspace\index.ts" -ErrorAction SilentlyContinue | Select-Object -First 5
```
...
Read lines 143鈥?54 of page.tsx to identify the exact `return` block structure before editing.
...
**Note:** `SubmarineLaunchpad` in page.tsx is no longer needed 鈥?its "start a conversation" prompt is replaced by the inline chat rail's `isNewThread` autoFocus. Remove it and its helper components (`RuntimePlaceholder`, `CollaborationStep`) from page.tsx.
...
- Submarine sidebar shows "VibeCFD 路 DeerFlow" brand + stage nav + new simulation button
...
The design spec is at: docs/archive/superpowers/specs/2026-03-30-vibecfd-frontend-redesign-design.md
...
| 3.2 Activity Bar / workbench navigation | 宸叉湁 WorkspaceSidebar + WorkspaceNavChatList锛屼笉閲嶅寤猴紱Task 6 宸茬Щ闄?|
| 3.3 Color theme (light, stone/sky) | Tailwind classes throughout |
| 4.1 Left sidebar | SubmarinePipelineSidebar (Task 3)锛況un list 鐢?useThreads() 鍦?Task 7 鍐呴儴鏌ヨ |
...
| 7.1 Navigation rules | chatOpen/onChatOpenChange 妗ユ帴 page.tsx 鐜版湁 toggle锛泃hread 鍒涘缓鐢?history.replaceState锛坧age.tsx 涓嶅彉锛?|
| 7.2 Panel width persistence | onLayoutChanged 鈫?localStorage锛沴oadStoredPct 鈫?defaultLayout锛圱ask 7锛?|
| 8. Migration boundary (providers preserved) | layout.tsx / WorkspaceLayout 涓嶅姩锛沺age.tsx 淇濈暀 ThreadContext銆丆hatBox |
| 9. Responsive (xl breakpoint) | < xl 鍗曞垪 + chatOpen toggle锛涒墺 xl ResizablePanelGroup + page header toggle hidden (`xl:hidden`) |

**No placeholders:** 姣忎釜 task 鐨勪唬鐮佸潎瀹屾暣锛屾棤 TBD銆?
**Type consistency:** `StageRuntimeSnapshot`锛坰ubmarine-stage-cards.tsx锛夋槸 `SubmarineRuntimeSnapshot`锛坰ubmarine-pipeline.tsx锛夌殑瀛愰泦锛岄€氳繃 `stageSnapshot` useMemo 鏄犲皠銆俙buildSubmarineTrendSeries` 杩斿洖 `SubmarineTrendSeries[]`锛屾瘡鏉℃湁 `id` + `values: TrendValue[]`锛屽彇 `id==="cd"` 鐨?`.values.map(v => v.value)` 寰?`number[]`锛堝凡楠岃瘉 trends.ts 绫诲瀷锛夈€?