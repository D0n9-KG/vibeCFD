...
Add a design-brief test that passes mixed natural-language outputs such as `阻力系数 Cd`, `表面压力云图`, `流线图`, and `中文结果报告`, then asserts the payload includes normalized `requested_outputs` with stable IDs and support flags.
...
**Files:**
- Modify: `docs/superpowers/specs/2026-03-27-vibe-cfd-research-readiness.md`
